...
/* Cheidi all'utente se vuole inserire altro numero
   Se lo vuole mettilo nella var B
   A questo punto B è di tipo intero se non ha voluto
   Se lo inserisce B diventa di tipo str
*/
/*
var A = 20
var B = 10
...
while (resp != "exit")
{
    ...
    conscount = resp.length - voccount

    // console.log("La lettera " + i + " della parola è " + resp[i])

    console.log("Il numero di vocali è " + voccount)
    console.log("Il numero di consonanti è " + conscount)

    console.log("Hai inserito " + resp)
    resp = prompt("Inserisci una parola ")
